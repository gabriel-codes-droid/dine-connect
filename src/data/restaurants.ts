...
export interface Restaurant {
  ...
  coverEmoji: string;      // visual stand-in until real images
  gallery: string[];       // gradient stops for the gallery
  menu: MenuItem[];
  reviews: Review[];
  featured?: boolean;
  openNow?: boolean;
...
export const restaurants: Restaurant[] = [
  {
    ...
    openNow: true,
    menu: [
      { id: 'gf-1', name: 'Beef Tartare', description: 'Hand-cut fillet, quail yolk, toasted brioche', price: 22, category: 'Starters' },
      { id: 'gf-2', name: 'Pan-Seared Foie Gras', description: 'Sauternes gel, fig compote, pain d’épices', price: 28, category: 'Starters' },
      { id: 'gf-3', name: 'Duck Confit', description: 'Slow-cooked leg, lentils du Puy, cherry reduction', price: 42, category: 'Mains' },
      { id: 'gf-4', name: 'Rack of Lamb', description: 'Herb crust, ratatouille, lamb jus', price: 48, category: 'Mains' },
      { id: 'gf-5', name: 'Crème Brûlée', description: 'Madagascar vanilla, caramelized sugar', price: 14, category: 'Desserts' },
  ...
  },
  {
    ...
    openNow: true,
    menu: [
      { id: 'ub-1', name: 'Truffle Croque Madame', description: 'Gruyère, mornay, sunny-side egg', price: 16, category: 'Starters' },
      { id: 'ub-2', name: 'Steak Frites', description: 'Bavette, herb butter, hand-cut fries', price: 26, category: 'Mains' },
      { id: 'ub-3', name: 'Cacio e Pepe', description: 'Tonnarelli, pecorino, black pepper', price: 22, category: 'Mains' },
      { id: 'ub-4', name: 'Buttermilk Pancakes', description: 'Bourbon maple, brown butter', price: 14, category: 'Starters' },
      { id: 'ub-5', name: 'Tarte Tatin', description: 'Caramelized apple, crème fraîche', price: 11, category: 'Desserts' },
    ],
    reviews: [
  ...
  },
  {
    ...
    openNow: true,
    menu: [
      { id: 'ta-1', name: 'Tonkotsu Ramen', description: '18-hour pork broth, chashu, ajitama', price: 18, category: 'Mains' },
      { id: 'ta-2', name: 'Xiaolongbao', description: 'Pork & crab soup dumplings, ginger vinegar', price: 14, category: 'Starters' },
      { id: 'ta-3', name: 'Wagyu Robatayaki', description: 'A5 striploin, yuzu kosho, sea salt', price: 38, category: 'Mains' },
      { id: 'ta-4', name: 'Mapo Tofu', description: 'Sichuan peppercorn, silken tofu, ground pork', price: 19, category: 'Mains' },
      { id: 'ta-5', name: 'Mochi Ice Cream Trio', description: 'Matcha, black sesame, mango', price: 9, category: 'Desserts' },
    ],
    reviews: [
  ...
  },
  {
    ...
    openNow: true,
    menu: [
      { id: 'pp-1', name: 'Margherita DOP', description: 'San Marzano, fior di latte, basil', price: 16, category: 'Mains' },
      { id: 'pp-2', name: 'Diavola', description: 'Spicy soppressata, chili oil, mozzarella', price: 19, category: 'Mains' },
      { id: 'pp-3', name: 'Burrata e Prosciutto', description: '24-month prosciutto, heirloom tomato', price: 15, category: 'Starters' },
      { id: 'pp-4', name: 'Tiramisu', description: 'Mascarpone, espresso, savoiardi', price: 9, category: 'Desserts' },
    ],
    reviews: [
  ...
  },
  {
    ...
    openNow: false,
    menu: [
      { id: 'sd-1', name: 'Oyster Trio', description: 'Kumamoto, Blue Point, Kumiai', price: 24, category: 'Starters' },
      { id: 'sd-2', name: 'Whole Branzino', description: 'Salt-crusted, lemon,橄榄 oil', price: 46, category: 'Mains' },
      { id: 'sd-3', name: 'Lobster Risotto', description: 'Maine lobster, saffron, parmesan', price: 42, category: 'Mains' },
      { id: 'sd-4', name: 'Seared Scallops', description: 'Cauliflower purée, brown butter', price: 34, category: 'Mains' },
    ],
    reviews: [
  ...
  },
  {
    ...
    openNow: true,
    menu: [
      { id: 'sp-1', name: 'Butter Chicken', description: 'Tandoor-roasted, tomato-cream, fenugreek', price: 18, category: 'Mains' },
      { id: 'sp-2', name: 'Lamb Biryani', description: 'Saffron, cardamom, slow-cooked', price: 22, category: 'Mains' },
      { id: 'sp-3', name: 'Paneer Tikka', description: 'Yogurt-marinated, mint chutney', price: 14, category: 'Starters' },
      { id: 'sp-4', name: 'Gulab Jamun', description: 'Cardamom syrup, pistachio', price: 7, category: 'Desserts' },
    ],
    reviews: [
  ...
  },
  {
    ...
    openNow: true,
    menu: [
      { id: 'cm-1', name: 'Al Pastor Tacos', description: 'Pineapple, cilantro, salsa verde', price: 4, category: 'Mains' },
      { id: 'cm-2', name: 'Mole Negro Enchiladas', description: '26-ingredient mole, queso fresco', price: 18, category: 'Mains' },
      { id: 'cm-3', name: 'Guacamole', description: 'Tableside, smoked salt, lime', price: 12, category: 'Starters' },
      { id: 'cm-4', name: 'Churros', description: 'Cinnamon sugar, dark chocolate', price: 8, category: 'Desserts' },
    ],
    reviews: [
  ...
  },
  {
    ...
    openNow: true,
    menu: [
      { id: 'tb-1', name: 'Pad Thai', description: 'Tamarind, peanuts, lime, choice of protein', price: 15, category: 'Mains' },
      { id: 'tb-2', name: 'Green Curry', description: 'Coconut, Thai basil, eggplant, bamboo', price: 17, category: 'Mains' },
      { id: 'tb-3', name: 'Mango Sticky Rice', description: 'Coconut cream, toasted sesame', price: 8, category: 'Desserts' },
      { id: 'tb-4', name: 'Tom Yum', description: 'Lemongrass, galangal, lime, prawns', price: 9, category: 'Starters' },
    ],
    reviews: [
  ...
  },
  {
    ...
    openNow: false,
    menu: [
      { id: 'am-1', name: 'Mezze Platter', description: 'Hummus, baba ganoush, dolmades, olives', price: 22, category: 'Starters' },
      { id: 'am-2', name: 'Whole Grilled Branzino', description: 'Lemon, oregano, olive oil', price: 38, category: 'Mains' },
      { id: 'am-3', name: 'Lamb Souvlaki', description: 'Yogurt marinade, pita, tzatziki', price: 28, category: 'Mains' },
      { id: 'am-4', name: 'Baklava', description: 'Walnut, honey, rose water', price: 9, category: 'Desserts' },
    ],
    reviews: [
  ...
  },
  {
    ...
    openNow: true,
    menu: [
      { id: 'bf-1', name: 'Classic Smash', description: 'Double patty, American cheese, pickles', price: 11, category: 'Mains' },
      { id: 'bf-2', name: 'Truffle Burger', description: 'Brisket blend, truffle aioli, gruyère', price: 16, category: 'Mains' },
      { id: 'bf-3', name: 'Crinkle Fries', description: 'Hand-cut, garlic salt, fry sauce', price: 6, category: 'Starters' },
      { id: 'bf-4', name: 'Bourbon Milkshake', description: 'Vanilla bean, bourbon, caramel', price: 9, category: 'Drinks' },
    ],
    reviews: [
