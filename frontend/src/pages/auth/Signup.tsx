...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!/^[a-zA-Z0-9]{3,30}$/.test(username.trim())) {
      setFieldErrors({ username: 'Username can only contain letters and numbers (3-30 chars)' });
      setError('Username can only contain letters and numbers (3-30 chars)');
      return;
    }
