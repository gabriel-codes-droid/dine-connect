...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-gray-50 dark:bg-gray-950">
      {/* Left — visual */}
      <div className="relative hidden lg:flex flex-col justify-between p-8 sm:p-12 overflow-hidden bg-gradient-to-br from-orange-700 via-orange-600 to-amber-700 text-white">
        ...
        <div className="relative">
          ...
          <p className="text-base sm:text-lg text-orange-100 max-w-md mb-6 sm:mb-8">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs sm:text-sm text-orange-100 ml-1.5">4.9 · 12k reviews</span>
            </div>
          </div>
        </div>

        <div className="relative flex items-center gap-2 text-xs sm:text-sm text-orange-200">
      ...
      <div className="flex items-center justify-center p-4 sm:p-6 md:p-12 relative">
        ...
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm sm:text-base mb-6 sm:mb-8">
            New here?{' '}
            <Link to="/signup" className="text-orange-600 dark:text-orange-400 hover:underline font-semibold">
              Create an account
            </Link>
            {' · '}
          ...
          <form onSubmit={handleLogin} className="space-y-4 mb-6 sm:mb-8" noValidate>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  className="w-full pl-10 pr-4 py-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
                  required
                  minLength={6}
                />
                <button
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all ${
                        active
                          ? 'border-orange-600 bg-orange-50 dark:bg-orange-950/30 dark:border-orange-500'
                    ...
                    >
                      ...
                      <div
                        className={`w-5 h-5 rounded-full border-2 flex-shrink-0 flex items-center justify-center ${
                          active ? 'border-orange-600 bg-orange-600' : 'border-gray-300 dark:border-gray-600'
                        }`}
                      >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 sm:py-3.5 rounded-xl transition-colors shadow-lg shadow-orange-200 dark:shadow-orange-900/30 flex items-center justify-center gap-2 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-4 sm:mt-6 text-center space-y-2">
            <Link
              to="/restaurants"
              className="block text-xs sm:text-sm font-semibold text-orange-600 dark:text-orange-400 hover:text-orange-700"
            >
